    ...
    if request.method == 'POST' and request.POST.get('action') != 'reset':
        ...
        if request.POST.get('action') == 'download_pdf':
            ...
            if lang == 'en':
                ...
                elements.append(Paragraph("Org.nr: 989 957 031", styles['Normal']))
                elements.append(Paragraph("Strandveien 90a, 9180 Skjervøy, Norway", styles['Normal']))
                elements.append(Paragraph("E-mail: yngvar.hansen@borealmaritim.no", styles['Normal']))
                elements.append(Paragraph("Phone: +47 77 77 75 00", styles['Normal']))
                elements.append(Paragraph("<br/><br/>", styles['Normal']))
            elif lang == 'no':
                elements.append(Paragraph("Tilbud", styles['Title']))
                elements.append(Paragraph("Boreal Maritim AS", styles['Normal']))
                elements.append(Paragraph("Org.nr: 989 957 031", styles['Normal']))
                elements.append(Paragraph("Strandveien 90a, 9180 Skjervøy, Norge", styles['Normal']))
                elements.append(Paragraph("E-post: yngvar.hansen@borealmaritim.no", styles['Normal']))
                elements.append(Paragraph("Telefon: +47 77 77 75 00", styles['Normal']))
                elements.append(Paragraph("<br/><br/>", styles['Normal']))
            else:
                elements.append(Paragraph("Смета", styles['Title']))
                elements.append(Paragraph("Boreal Maritim AS", styles['Normal']))
                elements.append(Paragraph("Орг.№: 989 957 031", styles['Normal']))
                elements.append(Paragraph("Strandveien 90a, 9180 Skjervøy, Норвегия", styles['Normal']))
                elements.append(Paragraph("E-mail: yngvar.hansen@borealmaritim.no", styles['Normal']))
                elements.append(Paragraph("Телефон: +47 77 77 75 00", styles['Normal']))
                elements.append(Paragraph("<br/><br/>", styles['Normal']))
